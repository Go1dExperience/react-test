...
function RentalSearchInput(props) {
    ...
    return (
        <div className="form-inline my-2 my-lg-0">
            <input onKeyPress={(event) => handleKeyPress(event)} ref={searchInput} type="search" className="form-control mr-sm-2 bwm-search" placeholder="Try 'New York'" aria-label="Search"></input>
