...
export default function BookingModal(props) {
    const {open, closeModal, booking, bookRental, errors, rentalPrice} = props;
        ...
        <div>
           <Modal open={open} onClose={closeModal} little classNames={{ modal: 'booking-modal' }}>
                ...
                <div className='modal-body'>
                    ...
                    <p>Guests: <em>{booking.Guest}</em></p>
                    <p>Price: <em>{booking.totalPrice}$ </em></p>
                    <p>Do you confirm your booking for selected days?</p>
                </div>
                <BwmResError errors={errors}></BwmResError>
                <div className='modal-footer'>
                    <button onClick={bookRental} type='button' className='btn btn-bwm'>Confirm</button>
